...
@media (max-width:600px) {
  ...
  #fifthButton {
    ...
    max-width: 150px;
    transform: translate(-30px, 600px); /* 位置：ここを好きな数字に変えられます */
  }
...
<img id="nextButton" src="/assets/images/1B.png">

<img id="thirdButton" src="/assets/images/2B.png">

<img id="fourthButton" src="/assets/images/3B.png">

<img id="fifthButton" src="/assets/images/4B.png">
